...
// checking if map access is available for current user.
    public boolean isServicesOK(){
        ...
        //not working
            ...
            Toast.makeText(this, "You can not access the map", Toast.LENGTH_SHORT).show();
        }
        return false;
    }
